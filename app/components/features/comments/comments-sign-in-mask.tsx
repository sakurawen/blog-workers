...
import { auth, githubSignIn } from '~/lib/auth';

export function CommentsSignInMask({ children }: PropsWithChildren) {
        ...
        <div className="h-full w-full flex justify-center items-center">
          <div>
            <div className="text-sm text-center pb-4">
              ...
              <p className="text-xs">
                如果你没有以下社交帐户，你可以给我
                <a className="text-black underline" href="mailto:wisakura@outlook.com" target="_blank">写信</a>
                交流
              </p>
            </div>
